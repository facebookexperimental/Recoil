...
export declare function tuple<Checkers extends [...unknown[]]>(
  ...checkers: Checkers
): Checker<{[K in keyof Checkers]: CheckerResult<Checkers[K]>}>;
...
declare class OptionalProperty<T> {
...
>(
  ...
  Readonly<
    {
      [K in keyof Checkers as Checkers[K] extends Checker<unknown>
        ? K
        : never]: CheckerResult<Checkers[K]>;
    } & {
      [K in keyof Checkers as Checkers[K] extends OptionalPropertyChecker<unknown>
        ? K
        : never]?: CheckerResult<Checkers[K]>;
    }
  >
 ...
 */
export declare function union<V>(
  ...checkers: ReadonlyArray<Checker<V>>
): Checker<V>;
...
export declare function custom<T>(
  checkValue: (value: unknown) => null | void,
