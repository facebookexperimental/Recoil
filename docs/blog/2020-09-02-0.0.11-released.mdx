...
Avoid using React experimental releases in production, and, no matter what release of React or state management library you use, [avoid bugs by always keep side-effects in a `useEffect` hook, not render](https://gist.github.com/sebmarkbage/75f0838967cd003cd7f9ab938eb1958f)!
