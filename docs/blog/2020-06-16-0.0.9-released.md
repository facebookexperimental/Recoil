...
- Some bug fixes for Server Side Rendering and React Native, though we do not officially support them yet. (#108, #233, #220, #284) - Thanks @dustinsoftware, @fyber-LJX, @Chrischuck, and @aulneau
...
TypeScript support is being rolled into the Recoil GitHub repository instead of `DefinitelyTyped` to help better keep it in sync with the API. (#292) - Thanks @csantos42
