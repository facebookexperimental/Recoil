...
- Atom effects
  - Rename option from `effects_UNSTABLE` to just `effects` as the interface is mostly stabilizing ([#1466](https://github.com/facebookexperimental/Recoil/pull/1466))
