...
- Atom effects
  ...
  - Call `onSet()` when atoms are initialized with `<RecoilRoot initializeState={...} >` ([#1509](https://github.com/facebookexperimental/Recoil/pull/1509), [#1519](https://github.com/facebookexperimental/Recoil/pull/1519))
