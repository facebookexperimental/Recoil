...
Recoil는 React를 위한 상태 관리 라이브러리다. 따라서 Recoil를 사용하기 위해서는 React가 설치되어 있어야 한다. React 애플리케이션을 시작하는 가장 쉽고 추천하는 방법은 [Create React App](https://github.com/facebook/create-react-app#creating-an-app)을 사용하는 것이다.
...
Recoil 패키지는 <a href="https://www.npmjs.com/get-npm" target="_blank">npm</a>에 존재합니다. 안정한 최신 버전을 설치하기 위해서는 아래의 명령어를 실행하면 된다.
