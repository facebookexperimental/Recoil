...
export type {RecoilBridge} from './hooks/Recoil_useRecoilBridge';
...
const useRecoilBridge = require('./hooks/Recoil_useRecoilBridge');
...
module.exports = {
  ...
  // Components
  RecoilRoot,
  useRecoilBridge_UNSTABLE: useRecoilBridge,
